...
export class Ludo {
    ...
    set turn(value) {
        this._turn = value;
        UI.setTurn(value, this.playerNames);

        // Update button color based on player turn
        const diceButton = document.querySelector('.btn-dice');

        if (value === 0) {
            // Player 1's turn
            diceButton.classList.remove('btn-player2');
            diceButton.classList.add('btn-player1');
        } else {
            // Player 2's turn
            diceButton.classList.remove('btn-player1');
            diceButton.classList.add('btn-player2');
        }
    }
    ...
    constructor(player1Name, player2Name) {
        this.playerNames.P1 = player1Name;
        this.playerNames.P2 = player2Name;

        console.log(`Hello ${player1Name} and ${player2Name}! Let's play Ludo!`);
